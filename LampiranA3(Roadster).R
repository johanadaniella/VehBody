testing11 <- subset(testing, testing$VehBody == "Roadster")
...
boxplot(data,
        ...
        main = "Perbandingan Data Asli dengan Hasil Model Terbaik dalam Prediksi Kerugian Jenis Kendaraan Roadster di Seluruh Data",
