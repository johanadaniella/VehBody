testing11 <- subset(testing, testing$VehBody == "Truck")
...
boxplot(data,
        ...
        main = "Perbandingan Data Asli dengan Hasil Model Terbaik dalam Prediksi Kerugian Jenis Kendaraan Truck di Seluruh Data",
