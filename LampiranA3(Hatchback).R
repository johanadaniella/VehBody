testing11 <- subset(testing, testing$VehBody == "Hatchback")
...
boxplot(data,
        ...
        main = "Perbandingan Data Asli dengan Hasil Model Terbaik dalam Prediksi Kerugian Jenis Kendaraan Hatchback di Seluruh Data",
