testing11 <- subset(testing, testing$VehBody == "Station wagon")
...
boxplot(data,
        ...
        main = "Perbandingan Data Asli dengan Hasil Model Terbaik dalam Prediksi Kerugian Jenis Kendaraan Station wagon di Seluruh Data",
