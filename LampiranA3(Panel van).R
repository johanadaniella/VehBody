testing11 <- subset(testing, testing$VehBody == "Panel van")
...
boxplot(data,
        ...
        main = "Perbandingan Data Asli dengan Hasil Model Terbaik dalam Prediksi Kerugian Jenis Kendaraan Panel van di Seluruh Data",
