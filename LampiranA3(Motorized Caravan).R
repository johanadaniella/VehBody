testing11 <- subset(testing, testing$VehBody == "Motorized caravan")
...
boxplot(data,
        ...
        main = "Perbandingan Data Asli dengan Hasil Model Terbaik dalam Prediksi Kerugian Jenis Kendaraan Motorized caravan di Seluruh Data",
