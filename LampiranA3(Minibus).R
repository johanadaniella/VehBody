testing11 <- subset(testing, testing$VehBody == "Minibus")
...
boxplot(data,
        ...
        main = "Perbandingan Data Asli dengan Hasil Model Terbaik dalam Prediksi Kerugian Jenis Kendaraan Minibus di Seluruh Data",
