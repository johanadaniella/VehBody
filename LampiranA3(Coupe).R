testing11 <- subset(testing, testing$VehBody == "Coupe")
...
boxplot(data,
        ...
        main = "Perbandingan Data Asli dengan Hasil Model Terbaik dalam Prediksi Kerugian Jenis Kendaraan Coupe di Seluruh Data",
