testing11 <- subset(testing, testing$VehBody == "Utility")
...
boxplot(data,
        ...
        main = "Perbandingan Data Asli dengan Hasil Model Terbaik dalam Prediksi Kerugian Jenis Kendaraan Utility di Seluruh Data",
